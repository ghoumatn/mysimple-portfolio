    ...
    <section id="home" className="overflow-hidden">
      <div className="min-h-screen relative flex md:flex-row flex-col-reverse md:items-end justify-center items-center">
        <div
          data-aos="slide-left"
          data-aos-delay="1200"
          className="absolute h-full md:w-4/12 w-8/12 top-0 right-0 bg-primaryLinear bottom-0 -z-10  hidden lg:block"
        >
        ...
        {/* first col */}
        <div className="pb-16 px-6 pt-5 w-full sm:w-1/2 sm:max-w-none custom-max-width mt-20 md:mt-0" data-aos="fade-down">
        ...
        {/* sec col */}
        <div className="md:h-[37rem] h-96 hidden lg:block">
          <img
            src={hero.image}
            data-aos="slide-up"
